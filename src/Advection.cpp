...
//void Advection reflection(double &zPos, double &wPrime, const double &z0,const double &disX
...
//
//    
//    pos u,n,vecS,prevPos,normal,vecZ,vecTmp,pI,r,l,pos,prmCurr;
...
//	  count=count+1;
//	  
//	  u.x =disX;// pos(pos) - prevPos;// u has disX,disY and disZ
//	  u.y =disY;
//	  u.z =disZ;
//          
//	  double s1 = -1.0; //for -x
...
//
//	  pos vecTmp1=VecScalarMult(u,smallestS);
...
//
//
//void Advection::average(const int tStep,const dispersion &disp){
//  
