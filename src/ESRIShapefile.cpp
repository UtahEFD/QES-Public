...
ESRIShapefile::ESRIShapefile(const std::string &filename, const std::string &bldLayerName, std::vector<std::vector<polyVert>> &polygons, std::vector<float> &building_height, float heightFactor)
