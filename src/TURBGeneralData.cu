...
void TURBGeneralData::getDerivatives_v2(WINDSGeneralData *WGD){
     int *icellfluid2 = &icellfluid[0];
     int icellfluidLength = icellfluid.size();
     float *Gxx2 = &Gxx[0], *Gxy2 = &Gxy[0], *Gxz2 = &Gxz[0], *Gyx2 = &Gyx[0], *Gyy2 = &Gyy[0], *Gyz2 = &Gyz[0], *Gzx2 = &Gzx[0], *Gzy2 = &Gzy[0], *Gzz2 = &Gzz[0], *WGDu = &(WGD->u[0]), *WGDv = &(WGD->v[0]), *WGDw = &(WGD->w[0]), *WGDx = &(WGD->x[0]), *WGDy = &(WGD->y[0]), *WGDz = &(WGD->z[0]), *WGDdz_array = &(WGD->dz_array[0]);
