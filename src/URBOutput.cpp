...
URBOutput::URBOutput(const URBInputData* UID, const URBGeneralData* UGD)

// create instance of output class of the different files
//Output* output = nullptr;

if (UID->fileOptions->outputFlag==1) {
  outputs.push_back(new Output(arguments.netCDFFile));
 }
