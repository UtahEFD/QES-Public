...
public:
    ...
    std::vector<double> x;   // this is the x values of the grid in m
    std::vector<double> y;   // this is the y values of the grid in m
    std::vector<double> z;   // this is the z values of the grid in m
    std::vector<double> t;   
    std::vector<double> icellflag;  
    ...
    // wind information
    std::vector<double> u;     // this is the set of mean wind in the x direction in m/s
    std::vector<double> v;     // this is the set of mean wind in the y direction in m/s
    std::vector<double> w;     // this is the set of mean wind in the z direction in m/s
};
