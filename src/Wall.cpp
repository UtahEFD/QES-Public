  ...
  /*for (auto i = 0; i < WGD->nx - 1; i++) {
    for (auto j = 0; j < WGD->ny - 1; j++) {
      for (auto k = 1; k < WGD->nz - 1; k++) {
        ...
        if ((i == 210 || i == 211) && (j == 315 || j == 316) && k == 113) {
      ...
      for (auto k = 1; k < WGD->nz - 2; k++) {
        ...
        if (WGD->icellflag[icell_cent] == 7 || WGD->icellflag[icell_cent] == 8) {
          ...
          /*if (i == 90 && j == 90) {
            ...
            std::cout << "WGD->icellflag[icell_cent+ (WGD->nx - 1)]:  " << WGD->icellflag[icell_cent + (WGD->nx - 1)] << std::endl;
            std::cout << "icell_cent:  " << icell_cent << std::endl;
            std::cout << "WGD->wall_indices.size():  " << WGD->wall_indices.size() << std::endl;
            std::cout << "WGD->f[icell_cent]:  " << WGD->f[icell_cent] << std::endl;
            std::cout << "WGD->e[icell_cent]:  " << WGD->e[icell_cent] << std::endl;
            std::cout << "WGD->g[icell_cent]:  " << WGD->g[icell_cent] << std::endl;
            std::cout << "WGD->h[icell_cent]:  " << WGD->h[icell_cent] << std::endl;
...
void Wall::wallLogBC(WINDSGeneralData *WGD)
{
  ...
  for (auto id = 0; id < WGD->wall_indices.size(); id++) {
    ...
    /*if (i == 114 && j == 100 && k == 9) {
      ...
      std::cout << "icell:  " << WGD->icellflag[WGD->wall_indices[id]] << std::endl;
      std::cout << "WGD->ni[WGD->wall_indices[id]]:  " << WGD->ni[WGD->wall_indices[id]] << std::endl;
      std::cout << "WGD->nj[WGD->wall_indices[id]]:  " << WGD->nj[WGD->wall_indices[id]] << std::endl;
      std::cout << "WGD->nk[WGD->wall_indices[id]]:  " << WGD->nk[WGD->wall_indices[id]] << std::endl;
    }*/
    ...
    if (WGD->center_id[WGD->wall_indices[id]] == 1 && count == 0) {
      ...
      while (condition) {
        ...
        dist2 = sqrt(pow((WGD->x[second_i] - WGD->x[i]), 2.0) + pow((WGD->y[second_j] - WGD->y[j]), 2.0)
                     + pow((WGD->z[second_k] - WGD->z[k]), 2.0))
                + WGD->wall_distance[WGD->wall_indices[id]];
        // If the cell distance from surface is ina way that creates negative velocity
    ...
    /*if (i == 90 && j == 90 && k == 9) {
      ...
      std::cout << "WGD->u0[second_id]:   " << WGD->u0[second_id] << std::endl;
      std::cout << "WGD->v0[second_id]:   " << WGD->v0[second_id] << std::endl;
      std::cout << "WGD->w0[second_id]:   " << WGD->w0[second_id] << std::endl;
      std::cout << "WGD->icellflag[cent]:  " << WGD->icellflag[cent] << std::endl;
      cent = second_i + second_j * (WGD->nx - 1) + second_k * (WGD->nx - 1) * (WGD->ny - 1);
      std::cout << "WGD->icellflag[cent]:  " << WGD->icellflag[cent] << std::endl;
      std::cout << "vel_tan_mag:   " << vel_tan_mag << std::endl;
      std::cout << "dot_product:   " << dot_product << std::endl;
      std::cout << "i:   " << i << std::endl;
      std::cout << "j:   " << j << std::endl;
      std::cout << "k:   " << k << std::endl;

      std::cout << "S_behind:  " << WGD->f[WGD->wall_indices[id]] << std::endl;
      std::cout << "S_front:  " << WGD->e[WGD->wall_indices[id]] << std::endl;
      std::cout << "S_left:  " << WGD->g[WGD->wall_indices[id]] << std::endl;
      std::cout << "S_right:  " << WGD->h[WGD->wall_indices[id]] << std::endl;
      std::cout << "S_below:  " << WGD->n[WGD->wall_indices[id]] << std::endl;
      std::cout << "S_above:  " << WGD->m[WGD->wall_indices[id]] << std::endl;
    }*/
    ...
    for (auto iter = 0; iter < 20; iter++) {
      ...
      /*if (i == 189 && j == 22 && k == 14) {
        ...
        std::cout << "dist1:   " << dist1 << std::endl;
        std::cout << "dist2:   " << dist2 << std::endl;
        std::cout << "WGD->z0:   " << WGD->z0 << std::endl;
        std::cout << "new_ustar:   " << new_ustar << std::endl;
      }*/
    }
    ...
    /*if (vel_mag1 > 5.0) {
      ...
      std::cout << "WGD->center_id[WGD->wall_indices[id]]:   " << WGD->center_id[WGD->wall_indices[id]] << std::endl;
      std::cout << "WGD->wall_distance[WGD->wall_indices[id]]:   " << WGD->wall_distance[WGD->wall_indices[id]] << std::endl;
      std::cout << "ustar_wall:   " << ustar_wall << std::endl;
      std::cout << "WGD->ti[WGD->wall_indices[id]]:   " << WGD->ti[WGD->wall_indices[id]] << std::endl;
      std::cout << "WGD->tj[WGD->wall_indices[id]]:   " << WGD->tj[WGD->wall_indices[id]] << std::endl;
      std::cout << "WGD->tk[WGD->wall_indices[id]]:   " << WGD->tk[WGD->wall_indices[id]] << std::endl;
      std::cout << "icell:  " << WGD->icellflag[WGD->wall_indices[id]] << std::endl;
      ...
      std::cout << "WGD->v0[first_id]:  " << WGD->v0[first_id] << std::endl;
      std::cout << "WGD->w0[first_id]:  " << WGD->w0[first_id] << std::endl;
      std::cout << "S_behind:  " << s_behind << std::endl;
      std::cout << "S_front:  " << s_front << std::endl;
      std::cout << "S_left:  " << s_left << std::endl;
