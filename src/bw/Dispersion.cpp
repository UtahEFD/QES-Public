...
//     std::cout<<"i "<<i<<" id "<<eul.sig.at(id).e11<<" "<<eul.sig.at(id).e22 <<" "<<eul.sig.at(id).e33<<" "<<std::endl;

//         std::cout<<"i "<<i<<" id "<<prime[i].x<<" "<<prime[i].y<<" "<<prime[i].z<<" "<<std::endl;
