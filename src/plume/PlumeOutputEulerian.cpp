  ...
  : QESNetCDFOutput(output_file)
{
  ...
  output_fields = { "t", "x", "y", "z", "u", "v", "w", "sig_x", "sig_y", "sig_z", "epps", "tke", "txx", "txy", "txz", "tyy", "tyz", "tzz", "dtxxdx", "dtxydy", "dtxzdz", "dtxydx", "dtyydy", "dtyzdz", "dtxzdx", "dtyzdy", "dtzzdz" };
