...
public:
   ...
   * :document this:
   *
   * @param haloX :document this:
   * @param haloY :document this:
   */
...
private:
   ...
   * :document this:
   *
   * @param name :document this:
   * @param allData :document this:
   * @param dimT :document this:
   * @param dimZ :document this:
   * @param dimY :document this:
   * @param dimX :document this:
   */
