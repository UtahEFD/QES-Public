...
testcasesFile = {'Sinusoidal3D_4_12','Sinusoidal3D_0.1_12',...
    'Sinusoidal3D_0.05_12','Sinusoidal3D_0.01_12'};

testcases = {'Sinusoidal3D_4o0_12o0','Sinusoidal3D_0o1_12o0',...
    'Sinusoidal3D_0o05_12o0','Sinusoidal3D_0o01_12o0'};

for k=1:numel(testcases)
    f=testcases{k};
    filename=sprintf('%s/%s_%s.nc',mainpath,testcasesFile{k},'particleInfo');
    [particleInfo.(f).data,particleInfo.(f).varname] = readNetCDF(filename);
end

for k=1:numel(testcases)
    f=testcases{k};
    filename=sprintf('%s/%s_%s.nc',mainpath,testcasesFile{k},'conc');
