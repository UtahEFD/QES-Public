...
[haxes,axpos]=tightSubplot(2,nProf,[2.0/figH 0.5/figW],1/figH*[1.5 0.5],1/figW*[2 0.5]);
...
for k=1:nProf
    ...
    htext=text(0.22,61,tmpstr,'interpreter','latex','FontSize',fsize);
...
for k=1:nProf
    ...
    htext=text(3,1.35,tmpstr,'interpreter','latex','FontSize',fsize);
    htext.BackgroundColor='w';
end
