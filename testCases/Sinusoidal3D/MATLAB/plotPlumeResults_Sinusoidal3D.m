...
% for k = 1:nCaseFolders
%     plumeParInfoInputFiles(k) = sprintf("%s/%s/%s_particleInfo.nc",plumeOutputFolder,caseFolders(k),...
%caseBaseName);
% end
...
wFluct_variances_Lim = [0, 5];
delta_wFluct_averages_Lim = [-10 10];
delta_wFluct_variances_Lim = [-5 20];
